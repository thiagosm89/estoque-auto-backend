...
const routes: Record<string, (req: Request) => Promise<Response>> = {
    "POST:/functions/v1/register-company": executeRegisterCompany(),
    "POST:/functions/v1/onboarding-company": executeOnboarding(),
    "POST:/functions/v1/get-current-term": executeGetCurrentTerm(),
};
